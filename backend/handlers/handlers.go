...
// @Summary Analyze CIDR ranges
// @Description Analyzes multiple CIDR ranges to find gaps, overlaps, and provide statistics
// @Tags CIDR Analysis
// @Accept json
// @Produce json
// @Param request body models.AnalysisRequest true "CIDR analysis request"
// @Success 200 {object} models.AnalysisResponse "Analysis results"
...
// @Summary Validate a single CIDR
// @Description Validates a single CIDR range and returns detailed information
// @Tags CIDR Analysis
// @Accept json
// @Produce json
// @Param request body models.ValidationRequest true "CIDR validation request"
// @Success 200 {object} models.CIDRRange "CIDR validation result"
// @Failure 400 {object} map[string]string "Invalid request format"
